    ...
    def SetupSNMP(self):
        ...
        try:
            ...
            if self.ControllerIsEvolutionNexus():
                ...
                # Status Engine
                self.AddOID((CtlID,0,0,0),return_type = str, description = "SwitchState", default = "Unknown", keywords = ["Status","Switch State"])
                self.AddOID((CtlID,0,0,1),return_type = str, description = "EngineState", default = "Unknown", keywords = ["Status","Engine State"])
                self.AddOID((CtlID,0,0,2),return_type = str, description = "ActiveRelays", default = "", keywords = ["Status","Active Relays"])
                self.AddOID((CtlID,0,0,3),return_type = str, description = "ActiveSensors", default = "", keywords = ["Status","Active Sensors"])
                self.AddOID((CtlID,0,0,4),return_type = str, description = "BatteryVolts", default = "0.0 V", keywords = ["Status","Battery Voltage"])
                self.AddOID((CtlID,0,0,5),return_type = str, description = "BatteryStatus", default = " ", keywords = ["Status","Battery Status"])
                self.AddOID((CtlID,0,0,6),return_type = str, description = "RPM", default = "", keywords = ["Status","RPM"])
                self.AddOID((CtlID,0,0,7),return_type = str, description = "Frequency", default = "0 Hz", keywords = ["Status","Frequency"])
                self.AddOID((CtlID,0,0,8),return_type = str, description = "OutputVoltage", default = "0 V", keywords = ["Status","Output Voltage"])
                self.AddOID((CtlID,0,0,9),return_type = str, description = "OutputCurrent", default = "0 A", keywords = ["Status","Output Current"])
                self.AddOID((CtlID,0,0,10),return_type = str, description = "OutputPower", default = "0 kW", keywords = ["Status","Output Power"])
                self.AddOID((CtlID,0,0,11),return_type = str, description = "RotorPoles", default = "", keywords = ["Status","Rotor Poles"])
                # Status Line
                self.AddOID((CtlID,0,1,0),return_type = str, description = "UtilityVoltage", default = "0 V", keywords = ["Status","Utility Voltage"])
                self.AddOID((CtlID,0,1,1),return_type = str, description = "UtilityVoltageMax", default = "0 V", keywords = ["Status","Utility Voltage Max"])
                self.AddOID((CtlID,0,1,2),return_type = str, description = "UtilityVoltageMin", default = "0 V", keywords = ["Status","Utility Voltage Min"])
                self.AddOID((CtlID,0,1,3),return_type = str, description = "UtilityThresholdVoltage", default = "0 V", keywords = ["Status","Utility Threshold Voltage"])
                self.AddOID((CtlID,0,1,4),return_type = str, description = "UtilityPickupVoltage", default = "0 V", keywords = ["Status","Utility Pickup Voltage"])
                self.AddOID((CtlID,0,1,4),return_type = str, description = "SetOutputVoltage", default = "0 V", keywords = ["Status","Set Output Voltage"])
                # Status Last Alarms
