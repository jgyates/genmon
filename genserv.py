...
def AddRetryAddOnParam(AddOnCfg, addon_name, config_file):
    ...
    try:
        AddOnCfg[addon_name]['parameters']['max_retry_time'] = CreateAddOnParam(
            value = ConfigFiles[config_file].ReadValue("max_retry_time", return_type = int, default = 600),
            type = 'int',
        ...
        AddOnCfg[addon_name]['parameters']['default_wait'] = CreateAddOnParam(
            value = ConfigFiles[config_file].ReadValue("default_wait", return_type = int, default = 120),
            type = 'int',
