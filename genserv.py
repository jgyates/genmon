...
def GetAddOns():
    ...
    try:
        ...
        AddOnCfg['genpushover']['parameters']['appid'] = CreateAddOnParam(
            ...
            display_name = "Application ID. This is generatated by pushover.net when an application is created for your account.")
        AddOnCfg['genpushover']['parameters']['userid'] = CreateAddOnParam(
            ...
            "Pushover user ID.",
            bounds = 'required minmax:5:50',
            display_name = "Pushover User Key. Note: this is not your login user name but a key generated by pushover.net for your account")
